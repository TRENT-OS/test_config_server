...
#define SELECT_START(PREFIX,_3,_2,_1,_0,SUFFIX,...) PREFIX ## _ ## SUFFIX
#define _TEST_START_STOP(...) \
    Debug_ASSERT_PRINTFLN(0, "Too many arguments for TEST_START.")
#define _TEST_START_3(arg0, arg1, arg2) \
    snprintf(testName, sizeof(testName), "%s(%s=%i,%s=%s,%s=%s)", __func__, #arg0, (int)arg0, #arg1, arg1, #arg2, arg2)
#define _TEST_START_2(arg0, arg1) \
    snprintf(testName, sizeof(testName), "%s(%s=%i,%s=%s)", __func__, #arg0, (int)arg0, #arg1, arg1)
...
#define TEST_START(...) \
    SELECT_START(_TEST_START, ## __VA_ARGS__,STOP,3,2,1,0)(__VA_ARGS__)
...
#define TEST_CFG_PARAMETER_NOT_FOUND(fn) \
    ASSERT_ERR(fn, OS_ERROR_CONFIG_PARAMETER_NOT_FOUND)
